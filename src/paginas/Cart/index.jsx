...
const Cart = () => {
    ...
    if (!carts.length) {
        return <div className=' h-[55vh] flex justify-center items-center mt-20 text-4xl'>Carrito Vacío</div>;
    }
    return (
        ...
        <div className='container mx-auto mt-20'>
            <div className='flex shadow-md my-10'>
                <div className='w-3/4 bg-white px-10 py-10'>
                    ...
                    <div className='flex  items-stretch mt-10  items-stretch"'>
                    ...
                    </div>
                    {
                        carts?.map((cart) => {
                            return (
                                <div className='flex items-center hover:bg-gray-100 -mx-6 px-6 py-5'>
                                    <div className='flex w-2/5'>
                                        <div className='w-20'>
                                            <img className='h-24  ml-6 object-contain ' src={cart?.image} alt={cart?.title} />
                                        </div>
                                        <div className='flex flex-col justify-between ml-6 flex-grow'>
                                            ...
                                            <div className='font-semibold ml hover:text-red-500 text-gray-500 text-xs cursor-pointer' onClick={()=> removeProduct(cart?.id)}>Remove</div>
                                        </div>
                                    </div>
                                    <div className='flex justify-center w-1/5'>
                                        <svg className='fill-current text-gray-600 w-3 cursor-pointer justify-end ml-auto' viewBox='0 0 448 512' onClick={() => handleDec(cart?.id)}><path d='M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z' />
                                        </svg>
