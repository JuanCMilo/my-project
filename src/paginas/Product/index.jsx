    ...
    <section className='text-gray-600 body-font overflow-hidden'>
      <div className='container px-5 py-24 mx-auto'>
        <div className='lg:w-4/5 mx-auto flex flex-wrap'>
          <img alt={product?.title} className='lg:w-1/2 w-full lg:h-auto h-62 object-contain object-center rounded' src={product?.image} />
          <div className='lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0'>
            ...
            <div className='flex justify-between items-center mt-10'>
              ...
              <div className='flex '>
              <button className='flex ml-auto mr-1 text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded'onClick={() => handleCart(product, true)} >Comprar Ya</button>
              <button className='flex ml-auto text-gray-600 border-0 py-2 px-6 focus:outline-none hover:text-white hover:bg-purple-600  rounded' onClick={() => handleCart(product)}>Añadir al carrito</button>
              </div>            
             </div>
          </div>
        </div>
